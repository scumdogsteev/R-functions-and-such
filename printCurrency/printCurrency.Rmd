...
title: "printCurrency"
author: "Steve Myles"
date: "24 May 2015 (updated 11 June 2015)"
output:
  pdf_document:
    toc: no
  html_document:
...
##### [R script](http://projects.mylesandmyles.info/R-functions-and-such/printCurrency/printCurrency.R) | [Rmd](http://projects.mylesandmyles.info/R-functions-and-such/printCurrency/printCurrency.Rmd) | [pdf](http://projects.mylesandmyles.info/R-functions-and-such/printCurrency/printCurrency.pdf) | [License](https://github.com/scumdogsteev/R-functions-and-such/blob/master/LICENSE)
$\\$
