...
output:
  ...
  html_document:
    toc: no
---
##### [R script](http://projects.mylesandmyles.info/R-functions-and-such/download_and_unzip/download_and_unzip.R) | [Rmd](http://projects.mylesandmyles.info/R-functions-and-such/download_and_unzip/download_and_unzip.Rmd) | [pdf](http://projects.mylesandmyles.info/R-functions-and-such/download_and_unzip/download_and_unzip.pdf) | [License](https://github.com/scumdogsteev/R-functions-and-such/blob/master/LICENSE)
$\\$
