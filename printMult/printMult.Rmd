...
title: "printMult"
author: "Steve Myles"
date: "4 June 2015 (updated 11 July 2015)"
output:
  html_document:
    toc: no
  pdf_document:
    toc: no
---
##### [R script](http://projects.mylesandmyles.info/R-functions-and-such/printMult/printMult.R) | [Rmd](http://projects.mylesandmyles.info/R-functions-and-such/printMult/printMult.Rmd) | [pdf](http://projects.mylesandmyles.info/R-functions-and-such/printMult/printMult.pdf) | [License](https://github.com/scumdogsteev/R-functions-and-such/blob/master/LICENSE)
$\\$
