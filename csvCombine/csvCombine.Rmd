...
output:
  ...
  html_document:
    toc: no
---
##### [R script](http://projects.mylesandmyles.info/R-functions-and-such/csvCombine/csvCombine.R) | [Rmd](http://projects.mylesandmyles.info/R-functions-and-such/csvCombine/csvCombine.Rmd) | [pdf](http://projects.mylesandmyles.info/R-functions-and-such/csvCombine/csvCombine.pdf) | [License](https://github.com/scumdogsteev/R-functions-and-such/blob/master/LICENSE)
$\\$
